  ...
  <div class="div__booking">
    ...
    <form action="/booking" method="POST" class="form__booking">
      ...
      <div class="div__inner">
        <input class="input__date" id="input__date" type="date" min="2024-03-06">
        <select class="select__time" id="select__time">
          @foreach ($store->getHours() as $key => $value)
            <option value="{{$key}}">{{$value}}</option>
          @endforeach
        </select>
        <select class="select__number" id="select__number">

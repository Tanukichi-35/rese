...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'imageURL' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('stores')->insert($param);
        ...
        $param = [
            ...
            'imageURL' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('stores')->insert($param);
        ...
        $param = [
            ...
            'imageURL' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg'
        ];
        DB::table('stores')->insert($param);
        ...
        $param = [
            ...
            'imageURL' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('stores')->insert($param);
